...
static unsigned int initial_gpio_table[][4] =
{
	...
	{S5PV210_GPG3(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
#else
    ...
    {S5PV210_GPH1(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_DOWN},
    {S5PV210_GPH1(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE, S3C_GPIO_PULL_DOWN},
#else //CONFIG_SAMSUNG_VIBRANT CONFIG_SAMSUNG_GALAXYS CONFIG_SAMSUNG_FASCINATE
	...
	{S5PV210_GPJ0(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //oc fix
	...
	{S5PV210_GPJ2(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
        {S5PV210_GPJ2(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPJ2(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
#else
	...
	{S5PV210_GPJ2(5), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, 
...
static unsigned int sleep_gpio_table[][3] =
{
...
#else //CONFIG_SAMSUNG_GALAXYS CONFIG_SAMSUNG_FASCINATE
	...
	// GPB	-------------------------------------------------
#if defined(CONFIG_ARIES_NTT) || defined (CONFIG_SAMSUNG_CAPTIVATE) || defined (CONFIG_SAMSUNG_VIBRANT)
...
#endif
//	{S5PV210_GPB(3),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	OLD GPIO_BT_nRST
	{S5PV210_GPB(3),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_TOUCH_INT (FIXED) (ffosilva - 07-06-2011)
...
//	{S5PV210_GPB(6),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	OLD GPIO_GPB6
	{S5PV210_GPB(6),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_BT_nRST (FIXED) (ffosilva - 07-06-2011)
...
#if defined(CONFIG_ARIES_NTT) || defined (CONFIG_SAMSUNG_CAPTIVATE) || defined (CONFIG_SAMSUNG_FASCINATE)
...
#else //CONFIG_SAMSUNG_VIBRANT CONFIG_SAMSUNG_GALAXYS
...
#if defined(CONFIG_SAMSUNG_FASCINATE)
	{S5PV210_GPG2(1), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_T_FLASH_CMD
#else
...
#endif
#if defined(CONFIG_SAMSUNG_FASCINATE)
	{S5PV210_GPG2(3), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_T_FLASH_D0
	{S5PV210_GPG2(4), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_T_FLASH_D1
	{S5PV210_GPG2(5), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_T_FLASH_D2
	{S5PV210_GPG2(6), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_T_FLASH_D3
#else
...
//  	{S5PV210_GPG3(0), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},
	...
	{S5PV210_GPG3(2), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE}, //oc fix

#else //CONFIG_SAMSUNG_CAPTIVATE CONFIG_SAMSUNG_GALAXYS CONFIG_SAMSUNG_FASCINATE
  	{S5PV210_GPG3(0), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},
  	{S5PV210_GPG3(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},
#endif
	...
	// GPI --------------------------------------------------
#if defined(CONFIG_SAMSUNG_FASCINATE)
	{S5PV210_GPI(0),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_DOWN},		//GPIO_CODEC_I2S_CLK
#else
...
#endif
#if defined(CONFIG_SAMSUNG_FASCINATE)
	{S5PV210_GPI(2),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_DOWN},		//GPIO_CODEC_I2S_WS
	{S5PV210_GPI(3),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_DOWN},		//GPIO_CODEC_I3S_DI
	{S5PV210_GPI(4),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_DOWN},		//GPIO_CODEC_I3S_DO
#else
...
{S5PV210_GPJ0(1), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_MSENSE_SDA_28V
	...
	{S5PV210_GPJ0(2), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},	//GPIO_HWREV_MODE0
	{S5PV210_GPJ0(3), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},	//GPIO_HWREV_MODE1
	{S5PV210_GPJ0(4), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},	//GPIO_HWREV_MODE2
	{S5PV210_GPJ0(5), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},	//GPIO_TOUCH_INT
	{S5PV210_GPJ0(6), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_CAM_MEGA_EN
	{S5PV210_GPJ0(7), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_CAM_MEGA_EN (FIXED) (ffosilva - 07-06-2011)
#elif (CONFIG_SAMSUNG_GALAXY) //All the others
...
#endif
	// GPJ1 -------------------------------------------------
#if defined(CONFIG_ARIES_NTT) || defined (CONFIG_SAMSUNG_CAPTIVATE)
...
#elif defined (CONFIG_SAMSUNG_GALAXYSB)
  	{S5PV210_GPJ2(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_GPJ20
  	{S5PV210_GPJ2(1), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_GPJ21
#else //CONFIG_SAMSUNG_VIBRANT CONFIG_SAMSUNG_GALAXYS CONFIG_SAMSUNG_FASCINATE
...
#else
	{S5PV210_GPJ2(2), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_OLED_DET
#if defined(CONFIG_ARIES_NTT)
	...
	{S5PV210_GPJ2(5), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_SUB_MICBIAS_EN
  	...
  	{S5PV210_GPJ2(5), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_SUB_MICBIAS_EN
#elif defined(CONFIG_SAMSUNG_GALAXYSB)
  	{S5PV210_GPJ2(3), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_NONE},	//GPIO_GPJ23
...
#if defined(CONFIG_SAMSUNG_FASCINATE)
	{S5PV210_GPJ2(6), S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN},	//GPIO_EARPATH_SEL
...
#elif defined (CONFIG_SAMSUNG_GALAXY)                           //CONFIG_SAMSUNG_VIBRANT CONFIG_SAMSUNG_GALAXYS CONFIG_SAMSUNG_FASCINATE
...
#elif defined (CONFIG_SAMSUNG_GALAXYS) //CONFIG_SAMSUNG_VIBRANT CONFIG_SAMSUNG_GALAXYS CONFIG_SAMSUNG_FASCINATE
...
static unsigned int sleep_alive_gpio_table[][4] =
{
...
#elif defined (CONFIG_SAMSUNG_CAPTIVATE) || defined(CONFIG_SAMSUNG_FASCINATE)
...
#if defined (CONFIG_SAMSUNG_CAPTIVATE)
  	{S5PV210_GPH0(7), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, //GPIO_AP_PMIC_IRQ
  	{S5PV210_GPH1(0), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},	
#elif defined(CONFIG_SAMSUNG_FASCINATE)
	...
	{S5PV210_GPH2(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},
  	...
  	{S5PV210_GPH3(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP},	//GPIO_KBR0
  	{S5PV210_GPH3(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, //GPIO_KBR1
  	{S5PV210_GPH3(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP}, //GPIO_KBR2
#elif defined(CONFIG_SAMSUNG_FASCINATE)
...
#endif
#if defined(CONFIG_SAMSUNG_FASCINATE)
	{S5PV210_GPH3(4), S3C_GPIO_EINT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_UP},	//GPIO_KBR4
#endif
#if defined (CONFIG_SAMSUNG_CAPTIVATE)
  	{S5PV210_GPH3(5), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_OK_KEY
  	{S5PV210_GPH3(7), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_ONE,  S3C_GPIO_PULL_UP},	//GPIO_CP_RST
#elif defined(CONFIG_SAMSUNG_FASCINATE)
  	{S5PV210_GPH3(5), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_OK_KEY
